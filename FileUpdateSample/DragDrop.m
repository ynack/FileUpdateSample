...
-(void)awakeFromNib
{
    ...
    //NSArray *parrTypes = [NSArray arrayWithObject:NSPasteboardTypeFileURL];
...
-(NSArray *)fileListInDraggingInfo:(id <NSDraggingInfo>)info
{
    ...
    //ドラッグされたファイルの一覧取得
    NSArray *parrFiles = [pboard propertyListForType:NSFilenamesPboardType]; //※10.14から廃止
    //NSArray *parrFiles = [pboard propertyListForType:NSPasteboardTypeFileURL];
